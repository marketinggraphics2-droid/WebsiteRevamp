...
add_action( 'customize_register', function ( WP_Customize_Manager $wp ) {
	...
	$text( 'dq_header_cta_text', __( 'Top bar text', 'dynamiqes' ), 'Something slowing your business down?', 'dq_brand' );
	$text( 'dq_header_cta_label', __( 'Top bar link label', 'dynamiqes' ), "Let's Figure it out!", 'dq_brand' );
